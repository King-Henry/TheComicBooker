...
public class MyLibraryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        com.getbase.floatingactionbutton.FloatingActionButton goToScanner =
                    (com.getbase.floatingactionbutton.FloatingActionButton) myLibraryView.findViewById(R.id.barcode_button);
        goToScanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent goToBarcode = new Intent(getActivity(),GoogleBarcodeScannerActivity.class);
